        ...
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            <Image
              ...
              priority
            />
            <h2 className="text-3xl font-bold text-ipoten-gray-dark">로그인</h2>
            <p className="mt-2 text-sm text-gray-600">
              아이포텐과 함께 우리 아이의 발달을 확인해보세요
            </p>
          </div>
          ...
          <form className="mt-8 space-y-6" onSubmit={handleLogin}>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-ipoten-blue focus:ring-ipoten-blue border-gray-300 rounded"
                />
              ...
              <div className="text-sm">
                <Link href="/forgot-password" className="font-medium text-ipoten-blue hover:text-blue-600">
                  비밀번호 찾기
                </Link>
              </div>
            </div>
            ...
            <div className="text-center">
              <span className="text-sm text-gray-600">
                아직 회원이 아니신가요?{' '}
                <Link href="/signup" className="font-medium text-ipoten-blue hover:text-blue-600">
                  회원가입
                </Link>
              </span>
            </div>
            ...
            <div className="space-y-3">
              ...
              >
                <svg className="w-5 h-5 mr-2" fill="#FEE500" viewBox="0 0 24 24">
                  <path d="M12 3C6.48 3 2 6.31 2 10.5c0 2.69 1.85 5.05 4.64 6.38-.2.72-.75 2.69-.87 3.11-.14.5.18.52.38.38.16-.11 2.61-1.76 3.66-2.47.68.11 1.42.17 2.19.17 5.52 0 10-3.31 10-7.5S17.52 3 12 3z" />
                </svg>
                카카오로 계속하기
              </button>
            </div>
